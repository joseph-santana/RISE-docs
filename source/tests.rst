...
There is negligible difference between the S/N of a given source between the two stacking methods or the two differencing algorithms.
...
We see that SFFT outperforms ZOGY in terms of the number of sources extracted, while Stack+Sub outperforms Sub+Stack using SFFT.
